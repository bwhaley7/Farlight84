...
private:
	...
	static constexpr auto XOR_KEY = static_cast<value_type>(
		const_atoi(__TIME__[7]) * 3 +
		const_atoi(__TIME__[6]) * 30 +
		const_atoi(__TIME__[4]) * 90 +
		const_atoi(__TIME__[3]) * 900 +
		const_atoi(__TIME__[1]) * 6900 +
		const_atoi(__TIME__[0]) * 69000
		);
...
#define _Seed ((__TIME__[7] - '0') * 3  + (__TIME__[6] - '0') * 30  + \
              (__TIME__[4] - '0') * 90   + (__TIME__[3] - '0') * 900 + \
              (__TIME__[1] - '0') * 6900 + (__TIME__[0] - '0') * 69000)
////////////////////////////////////////////////////////////////////


////////////////////////////////////////////////////////////////////
constexpr int LinearCongruentGenerator(int Rounds) {
    return 1013904223 + 1664525 * ((Rounds > 0) ? LinearCongruentGenerator(Rounds - 1) : _Seed & 0xFFFFFFFF);
}
...
#define xorstr_(str) _xor_(str).c_str()